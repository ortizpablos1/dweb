<template>
  <div class="home">
    <header>
      <a href="#"><img class="logo" src="@/assets/img/logo.svg" alt="Logo"></a>
      <nav>
        <ul class="menu">
          <li>Inicio</li>
          <li>Nosotros</li>
          <li>Conctacto</li>
          <li class="ingreso"><b>Entrar</b></li>
        </ul>
      </nav>
    </header>
    <main>
...
import TemasCompoment from '@/components/TemasCompoment.vue';
